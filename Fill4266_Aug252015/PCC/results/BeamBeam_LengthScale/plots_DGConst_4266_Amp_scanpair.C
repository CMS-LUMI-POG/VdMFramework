...
//=========  (Sun Feb  7 16:36:16 2016) by ROOT version5.34/32
   ...
   c1_n2->Range(-1.25,93.23445,12.25,110.6505);
   ...
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","4266 PCC DGConst Amp",100,0.1,10.9);
   Graph_Graph29->SetMinimum(94.97605);
   Graph_Graph29->SetMaximum(108.9089);
   ...
   Graph_Graph29->GetXaxis()->SetTitle("Scan");
   ...
   Graph_Graph29->GetYaxis()->SetTitle("Amp");
