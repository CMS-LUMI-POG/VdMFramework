...
2. Step 1 clones only the master BRANCH of the CMS-LUMI-POG/VdMFramework (from now on origin). To fetch all the BRANCHS of the origin, 
   `git fetch origin`
...
8. If step 7 fails, i.e. if git complains with 
