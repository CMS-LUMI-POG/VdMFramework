...
//=========  (Sun Feb  7 16:33:53 2016) by ROOT version5.34/32
   ...
   c1_n2->Range(-1.25,11.5,12.25,20.5);
   ...
   gre->SetPoint(0,10,19);
   gre->SetPointError(0,0,0);
   gre->SetPoint(1,10,19);
   gre->SetPointError(1,0,0);
   gre->SetPoint(2,10,19);
   gre->SetPointError(2,0,0);
   gre->SetPoint(3,10,19);
   gre->SetPointError(3,0,0);
   gre->SetPoint(4,10,19);
   ...
   Graph_Graph128->GetXaxis()->SetTitle("Scan");
   ...
   Graph_Graph128->GetYaxis()->SetTitle("ndof");
